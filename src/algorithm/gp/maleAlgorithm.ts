import { AgeCat, Alcohol, BinaryYN, BMI, Cholesterol, clampNum, EduCat, isYes, Smoking } from "../helpers";
import { Inputs, Scores } from "../types";

/** GP — MALE (updated from Excel GP sheet) */
export function maleAlgorithm(inputs: Inputs): Scores {
  // Categorical fields (keep existing enums)
  ...
  if (isYes(prior_stroke)) { dementia_score += 13; /* stroke not specified in Excel line */ mi_score += 3; /* diabetes 0 */ }
